...
6. **Redigir o brief:** Produza `analysis-brief.md` com: resumo executivo analítico, tabela RAG, lista de bloqueios com Five Whats, tendências/riscos, e lista de perguntas para o escritor (lacunas).
